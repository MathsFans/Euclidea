...
- 6.11 由三个中点确定的平行四边形 *8L 10E 3V* ⭐  
解：[8L，先作出平行四边形的中点，然后依次作出边。](solving/6.11.1.png)  
...
解：[14E，思路同9L，但是需要注意公用构造。](solving/d10.11.2.png)  
...
- 12.8 斜边和高 *6L 14E 4V* ⭐  
解：[6L14E，平移高到相应的位置。](solving/d12.8.1.png)  
注：[4V，如图做4个三角形得到隐藏星星。](solving/d12.8.2.png)  
