...
+ *3L5E*步骤：垂分，线，线
+ *3L5E*解题思路：菱型的两条对角线垂直且平分对方，两个顶点的垂分线必然通过另个两个顶点。[参考图](solved/1.5.3L5E.png) [GIF](GIF/1.5.3L5E.gif)
...
+ *5E*步骤：圆，圆，圆，线，线，点
+ *5E*解题思路：参考1.2可以用两个圆作中垂线。[参考图](solved/1.6.5E.png) [GIF](GIF/1.6.5E.gif)
